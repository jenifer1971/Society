...
class OasisProfileGenerator:
    ...
    def __init__(
        ...
        self._tools_service = None  # lazy init
    ...
    def _search_zep_for_entity(self, entity: EntityNode) -> Dict[str, Any]:
        """Search the graph for context about an entity using ZepToolsService."""
        ...
        try:
            ...
            if self._tools_service is None:
                self._tools_service = ZepToolsService()

            sr = self._tools_service.search_graph(
                graph_id=self.graph_id,
                query=entity.name,
                limit=20,
                scope="both",
            )
            results["facts"] = sr.facts
            results["node_summaries"] = [n.get("summary", "") for n in sr.nodes if n.get("summary")]
